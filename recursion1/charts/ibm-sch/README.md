...
```
- image: opencontent-common-utils:faf15a2-amd64
  references:
  - repository: opencontent-common-utils:faf15a2-amd64
    pull-repository: us.icr.io/icp-common-components/opencontent-common-utils:faf15a2-amd64
    pull-authorization:
      username:
